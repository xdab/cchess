...
void check_sample_position_1()
{
	...
	fen_put(&board, "2r3k1/p4ppp/b1N5/1p1P4/8/b5P1/n4PBP/B3R1K1 b - - 1 27");
	movegen_generate(&board, moves, &move_count);
	if (move_count != 27)
...
void check_sample_position_2()
{
	...
	fen_put(&board, "rnb1kbnr/p2p1ppp/5q2/1p3N1P/4PBP1/3P1Q2/PPP5/RN3KR1 w kq - 1 16");
	movegen_generate(&board, moves, &move_count);
	if (move_count != 42)
...
void check_sample_position_3()
{
	...
	fen_put(&board, "3r1rk1/1B3ppp/3b4/pp6/b2P4/2P1B3/1R1K1PPP/R7 w - - 0 27");
	movegen_generate(&board, moves, &move_count);
	if (move_count != 40)
